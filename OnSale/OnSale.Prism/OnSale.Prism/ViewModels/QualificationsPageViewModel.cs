...
namespace OnSale.Prism.ViewModels
{
    public class QualificationsPageViewModel : ViewModelBase
    {
        ...
        private DelegateCommand _addQualifacationCommand;
        ...
        public DelegateCommand AddQualificationCommand => _addQualifacationCommand ?? (_addQualifacationCommand = new DelegateCommand(AddQualificatioAsync));
        ...
        private async void AddQualificatioAsync()
        {
            if (Settings.IsLogin)
            {
